...
parser.add_argument('--src-dir', default='C:\TTLastLaffFirstQA\Toontown-Last-Laff-Workspace\src',
...
parser.add_argument('--configprc-dir', default='config',
                    help='The directory of the Panda3D Config.prc.')
parser.add_argument('--general-prc', default='general.prc',
                    help='The directory of the Panda3D Config.prc.')
parser.add_argument('--qa-prc', default='dev.prc',
                    help='The directory of the Panda3D Config.prc.')

#Argument for the location of the Astron dclass.
parser.add_argument('--dclass-dir', default='astron/dclass',
